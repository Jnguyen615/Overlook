...
-Fork the  [backend repoository](https://github.com/turingschool-examples/overlook-api) here
...
- Fork the [frontend repository]('https://github.com/Jnguyen615/Overlook') here
- Clone it to your local machine using the command: git clone git@github.com:Jnguyen615/Overlook.git
